...
## 입력 
- [ ] 비상 근무 배정 월과 시작 요일 입력 (쉼표로 구분 : 5,월)
...
```
  - [ ] 월,요일 외에 다른 문자 입력했을 경우
  - [ ] 월이 1월 미만, 12월 초과일 경우
  - [ ] 요일이 (월,화,수,목,금)이 아닐 경우
<br>
...
```
  ...
  - [ ] 닉네임이 중복될 경우
  - [ ] 비상 근무 사원이 5명 미만, 35명 초과 일 경우
  - [ ] 평일 비상 근무 사원에 없는 닉네임이 존재할 경우
<br>

## 근무 배정
- [ ] 순번에 따라 비상 근무일을 배정한다.
  - [ ] 휴일(토요일, 일요일, 법정공휴일) 체크 후 휴일일 경우, 휴일 순번에 따라 배정
    - [ ] 평일이면서 법정 공휴일의 경우 요일 뒤에 (휴일) 표기
  - [ ] 휴일이 아닐 경우, 평일 순번에 따라 배정
- [ ] 비상 근무자는 어떤 경우에도 연속 2일은 근무할 수 없다.
  - [ ] 해당 배정 사원이 전날 배정되었는지 확인, 배정되었을 경우 뒷 순번이라 교체
  - [ ] 교체한 경우 기록 필수
